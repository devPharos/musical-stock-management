...
export default function ConfirmacaoTransf() {
  ...
  const handleEndConference = async () => {
    const body = {
      ...
      armazem_origem: originAddress.ARMAZEM,
      endereco_origem: originAddress.ENDERECO,
      armazem_destino: destinationAddress.ARMAZEM,
      endereco_destino: destinationAddress.ENDERECO,
    }
    // console.log(body)
    axios
