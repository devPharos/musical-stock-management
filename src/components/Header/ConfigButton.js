...
export default function ConfigButton({ navigation }) {
    ...
    // <TouchableOpacity onPress={() => navigation.push('ConsultaEnderecoProvider')} style={{ borderRadius: 16, width: 32, height: 32, backgroundColor: colors['gray-500'], justifyContent: 'center', alignItems: 'center' }}>
